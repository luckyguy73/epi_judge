...
public class RangeLookupInBst {
    ...
    public static void rangeLookupInBstHelper(BstNode<Integer> tree, Interval interval, List<Integer> result) {
        ...
        } else if (interval.left > tree.data) rangeLookupInBstHelper(tree.right, interval, result);
        else rangeLookupInBstHelper(tree.left, interval, result);
    }

    public static void main(String[] args) {
        System.exit(GenericTest.runFromAnnotations(args, "RangeLookupInBst.java", new Object() {
