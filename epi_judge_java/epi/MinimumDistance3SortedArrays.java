...
public class MinimumDistance3SortedArrays {
    ...
    public static class ArrayData implements Comparable<ArrayData> {
        ...
        public int compareTo(ArrayData o) {
            ...
            if (result == 0) result = Integer.compare(idx, o.idx);
            return result;
        }
    ...
    public static int findMinDistanceSortedArrays(List<List<Integer>> sortedArrays) {
        ...
        while (true) {
            ...
            if (heads.get(idxNextMin) >= sortedArrays.get(idxNextMin).size()) return minDistanceSoFar;
    ...
    public static void main(String[] args) {
        System.exit(GenericTest.runFromAnnotations(args, "MinimumDistance3SortedArrays.java", new Object() {
