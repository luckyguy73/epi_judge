...
public class TreeFromPreorderInorder {
    ...
    binaryTreeFromPreorderInorder(List<Integer> preorder, List<Integer> inorder) {
        ...
        return binaryTreeFromPreorderInorderHelper(preorder, 0, preorder.size(), 0, inorder.size(),
    ...
    binaryTreeFromPreorderInorderHelper(List<Integer> preorder, int preorderStart, int preorderEnd, int inorderStart,
