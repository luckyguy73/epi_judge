...
public class NextPermutation {
    ...
    public static List<Integer> nextPermutation(List<Integer> perm) {
        ...
        while (inversionPoint >= 0 && perm.get(inversionPoint) >= perm.get(inversionPoint + 1)) --inversionPoint;
        if (inversionPoint == -1) return Collections.emptyList(); // perm is the last permutation.
