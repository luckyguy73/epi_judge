...
public class LowestCommonAncestorInBst {
    ...
    public static BstNode<Integer> findLca(BstNode<Integer> tree, BstNode<Integer> s, BstNode<Integer> b) {
        ...
        while (p.data < s.data || p.data > b.data) {
            // LCA must be in p's right child.
    ...
    public static int lcaWrapper(TimedExecutor executor, BstNode<Integer> tree, Integer key0, Integer key1) throws Exception {
        ...
        if (result == null) throw new TestFailure("Result can't be null");
        return result.data;
    }

    public static void main(String[] args) {
        System.exit(GenericTest.runFromAnnotations(args, "LowestCommonAncestorInBst.java", new Object() {
